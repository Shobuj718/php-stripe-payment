...
//-------------------
  ...
  //ConfigurationInterface::getDefaultConfiguration()->setAccessToken($access_token);
  //ConfigurationDefaults::getDefaultConfiguration()->setAccessToken($access_token);

  /*$transaction_api = new TransactionsApi();
